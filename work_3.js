...
// - Создайте массив строк и объедините их в одну строку.
	...
	console.log(`ReduceRight: ${strArr.reduceRight((sum, value) => value + sum)}`);
	console.log(`Reduce: ${strArr.reduce((sum, value) => value + sum)}`);
...
/*
			!!! Замыкания это комбинация функции и лексического окружения, в котором эта функция была определена. !!! 
